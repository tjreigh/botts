      ...
      return runtime_1.wrap(function _callee2$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              commandFiles = readdirSync(this.commandFolder).filter(function (file) {
      ...
      return runtime_1.wrap(function _callee3$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              eventFiles = readdirSync(this.eventFolder).filter(function (file) {
                return file.endsWith('.js');
              });
